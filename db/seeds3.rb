Photo.create!([
  {caption: "The front of Velvet Taco", place_id: 1, picture: "velvet_taco.jpg", user_id: 2}
])
User.create!([
...
Comment.create!([
  {message: "Love", rating: "3_stars", user_id: 2, place_id: 1},
  {message: "Seriously, it rocks", rating: "5_stars", user_id: 1, place_id: 1},
...
Place.create!([
  ...
  {name: "Taco Planet", description: "The best taco food truck ever", address: "1411 Westheimer Rd, Houston, TX 77006", user_id: 1, latitude: 29.7429567, longitude: -95.3962661},
  ...
  {name: "Fuzzy's Tacos", description: "Fuzzy Fuzzy", address: "13881 Midway Rd Suite 105, Farmers Branch, TX 75244", user_id: 1, latitude: 32.9378237, longitude: -96.8395806},
  ...
  {name: "Velvet Taco 2", description: "Velvettyy", address: "3411 McKinney Ave, Dallas, TX 75204", user_id: 1, latitude: 32.8056021, longitude: -96.7988702},
